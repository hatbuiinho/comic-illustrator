...
- **part1-page003-nalini-volunteers/h1-nalini-holds-elder-hand** — Không tìm thấy output: ../pages/page-003/outputs/page003-option3-h1-nalini-holds-elder-hand-v1.png
- **part1-page003-nalini-volunteers/h2-nalini-warmed-by-volunteers** — Không tìm thấy output: ../pages/page-003/outputs/page003-option3-h2-nalini-warmed-by-volunteers-v1.png
- **part1-page006-process-20260918/rest-meal/optionAlignment** — Thiếu trường bắt buộc: optionId, selectedBrief, mustMatch, forbidden, layoutMapping, alignmentRationale.
- **part1-page006-process-20260918/rest-meal/optionAlignment** — Chưa có xác nhận userConfirmed: true cho Option-to-manifest QA.
- **part1-spread04-community-work/page004-community-work/optionAlignment** — Thiếu trường bắt buộc: optionId, selectedBrief, mustMatch, forbidden, layoutMapping, sourceRead, alignmentRationale.
- **part1-spread04-community-work/page004-community-work/delivery** — Frame đã được user xác nhận phải có delivery.required, delivery.status và delivery.output.
- **part1-spread04-community-work/page004-community-work** — Frame đã được user xác nhận nhưng chưa có output.
...
- **part1-page006-process-20260918/rest-meal** — Chưa có output; overlay chỉ hiển thị frame và guide.
...
- **part1-page006-process-20260918/printTrimLock** — Trim x 1.049% · y 1.478%; critical-safe x 2.797% · y 3.941%.
- **part1-page006-process-20260918/layoutQa** — Đã dùng layout gốc có text làm nền overlay: ../pages/page-006/storyboards/page006-layout-source-v1.png.
- **part1-spread04-community-work/printTrimLock** — Trim x 1.049% · y 1.478%; critical-safe x 2.797% · y 3.941%.
- **part1-spread04-community-work/layoutQa** — Đã dùng layout gốc có text làm nền overlay: ../pages/page-004/storyboards/page004-layout-source.png.
- **part1-spread04-community-work/page004-community-work/optionAlignment** — Option (không mã) đã được người dùng xác nhận.

## Overlay

- part1-spread01-chapter1-opening: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread01-chapter1-opening-overlay.svg` (source layout: `../pages/page-001/storyboards/page001-layout-source.png`)
- part1-spread15-chapter1-ending: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread15-chapter1-ending-overlay.svg` (source layout: `../tmp/pdf_all/p15.png`)
- part1-spread06-option1-shared-meal: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread06-option1-shared-meal-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_06_hi.png`)
- part1-spread06-option2-water-cup: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread06-option2-water-cup-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_06_hi.png`)
- part1-spread10-option2-nalini-realization: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread10-option2-nalini-realization-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_10_hi.png`)
- part1-spread10-option3-stone-vow: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread10-option3-stone-vow-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_10_hi.png`)
- part1-spread23-restart-option1-club-and-empty-hand: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread23-restart-option1-club-and-empty-hand-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_23.png`)
- part1-spread23-restart-option2-calm-and-disorientation: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread23-restart-option2-calm-and-disorientation-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_23.png`)
- part1-spread24-option1-circle-and-extinguished-lamp: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread24-option1-circle-and-extinguished-lamp-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_24.png`)
- part1-spread24-option1-fist-and-extinguished-lamp: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread24-option1-fist-and-extinguished-lamp-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_24.png`)
- part1-spread24-reprocess-optionA: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread24-reprocess-optionA-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_24.png`)
- part1-spread10-restart-option1-visakha-stone-gesture: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread10-restart-option1-visakha-stone-gesture-overlay.svg` (source layout: `../../../tmp/pdf_pages/page_10_hi.png`)
- part1-spread05-community-worksite-restart-v9: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread05-community-worksite-restart-v9-overlay.svg` (source layout: `../tmp/page-005-source/layout.png`)
- part1-page003-nalini-volunteers: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-page003-nalini-volunteers-overlay.svg` (source layout: `../pages/page-003/storyboards/page003-layout-source.png`)
- part1-page006-process-20260918: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-page006-process-20260918-overlay.svg` (source layout: `../pages/page-006/storyboards/page006-layout-source-v1.png`)
- part1-spread04-community-work: `/workspace/Tap 53/Part 1/pages/page-004/qa/option8-manifest-check-v1/part1-spread04-community-work-overlay.svg` (source layout: `../pages/page-004/storyboards/page004-layout-source.png`)
